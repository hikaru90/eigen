...
export function assertScoringReady(preflight: ScoringPreflight, evalMetricModel: string): void {
  if (
    !SUPPORTED_JUDGE_MODELS.includes(evalMetricModel as (typeof SUPPORTED_JUDGE_MODELS)[number])
  ) {
    throw new Error(
