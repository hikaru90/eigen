...
export type ChatTimelineKind =
  'llm_progress' | 'tool_call' | 'tool_executing' | 'tool_progress' | 'tool_result'
...
function toolResultPayloadFromMetadata(content: string, metadata: Record<string, unknown>): string {
