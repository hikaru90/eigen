export const CAPTURE_INGEST_PHASE_COPY = {
  ...
  graph: {
    ...
    description:
      'Upserting this thought as a node in the AGE graph so graph navigation stays aligned with Postgres.',
  },
  relations: {
    title: 'Resolving thought links',
    description:
      'Detecting references to other stored thoughts and persisting relation edges where matches exist.',
  },
  entities: {
    title: 'Updating entity graph',
    description:
      'Extracting and reconciling entities mentioned in this thought against your entity index.',
  },
  project_detection: {
  ...
  memory_type: {
    ...
    description:
      'Determining whether this thought is an episode, decision, concern, preference, or another memory type.',
  },
  cues: {
    title: 'Generating search cues',
    description:
      'Creating alternate search phrases so you can find this thought even when you remember it differently.',
  },
} as const
