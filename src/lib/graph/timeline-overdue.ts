...
export function itemStartDayKey(item: TemporalEventListItem, timeZone: string): string | null {
...
export function overdueElapsedMs(item: TemporalEventListItem, now = new Date()): number | null {
