...
/** Shared Web Push tag so multi-subscription sends collapse on the same device. */
export const GROUNDING_CHECK_IN_TAG = 'grounding-checkin'

/** Minimum interval between grounding/check-in pushes (onboarding + milestone share this). */
export const GROUNDING_PUSH_MIN_INTERVAL_MS = 86_400_000
